...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'githubtrigger', 'host' => 'localhost', 'port' => '', 'user' => 'editor', 'password' => 'secretPASSWORD', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_1e62e2798c1a43ce67ed6cb4d1c6756e');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_1e62e2798c1a43ce67ed6cb4d1c6756e');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_1e62e2798c1a43ce67ed6cb4d1c6756e');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\src\\My\\GithubTriggerBundle\\Entity')), 'My\\GithubTriggerBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('MyGithubTriggerBundle' => 'My\\GithubTriggerBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/config/routing_dev.yml', array('cache_dir' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\TwigBundle\\DependencyInjection/../../../Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev',
            'kernel.logs_dir' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/logs',
            'kernel.bundles' => array(
                ...
                'MyGithubTriggerBundle' => 'My\\GithubTriggerBundle\\MyGithubTriggerBundle',
            ...
            'debug.container.dump' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\vendor\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'sqlite:C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/profiler.db',
            ...
            'router.resource' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/../web',
            'assetic.write_to' => 'C:\\xampp\\htdocs\\podstawy-php\\unit-tests\\trigger-github\\Symfony\\app/../web',
